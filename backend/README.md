...
## Project Structure
    ...
    ├── testapiautocatalog_112994  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112994`
...
2. Clone this repo and `cd testapiautocatalog_112994`
